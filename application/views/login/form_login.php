...
<head>
    ...
    <title>KabarKabinet</title>

    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo base_url(''); ?>src/assets/images/favicon.png">
    <!-- Custom CSS -->
                ...
                <div class="h-100 d-flex align-items-center justify-content-center">
                    <div class="row justify-content-center text-center">
                        <div class="col-md-7 col-lg-12 col-xl-9">
                            <div>
                                <span class="db"><img src="<?php echo base_url(''); ?>src/assets/images/logos/logo-light-icon.png" alt="logo" /></span>
                                <span class="db"><img src="<?php echo base_url(''); ?>src/assets/images/logos/logo-kabar-kabinet.png" alt="logo" /></span>
                            </div>
                            <h2 class="text-white mt-4 fw-light"><span class="font-weight-medium">Fast & Responsive</span> </h2>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card" id="loginform">
                            <div class="card-body">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="password" class="form-control form-input-bg" id="text-password" name="pin" placeholder="masukan pin" required>
                                    <label for="text-password">PIN</label>
                                ...
                                <div class="d-flex align-items-stretch button-group mt-4 pt-2">
                                    <button type="submit" class="btn btn-info btn-lg px-4">Masuk</button>
                                </div>
                                <?php echo form_close(); ?>
                            </div>
                        </div>
